...
- `sdd-*` — SDD orchestration skills (loaded by orchestrator via phase matching)
- `skill-registry` — registry management itself
- `customize-opencode` — built-in skill, not file-based
...
- `/root/code/nebula-drift/.github/workflows/build-android.yml` — CI: runs `:core:test`, assembles debug APK
